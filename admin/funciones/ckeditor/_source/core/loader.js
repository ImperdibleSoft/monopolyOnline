	...
	CKEDITOR.loader = (function()
	{
		...
		var basePath = (function()
		{
			...
			if ( path.indexOf('://') == -1 )
			{
				// Absolute path.
				if ( path.indexOf( '/' ) === 0 )
/document'		: [ 'core/dom', 'core/dom/domobject', 'core/dom/window' ],
			...
			'core/htmlparser/fragment'	: [ 'core/htmlparser', 'core/htmlparser/comment', 'core/htmlparser/text', 'c					path = location.href.match( /^.*?:\/\/[^\/]*/ )[0] + path;
				// Relative path.
				else
