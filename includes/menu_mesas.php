<div id="header_inicio">
	...
	<ul style="position:relative; display:inline-block; float:right;">
		...
		if(isset($_SESSION['id_usuario'])){
			...
			echo '<li id="nombre_usuario" class="explicacion" alt="Tu nombre de usuario"><img height="18px" style="vertical-align: middle;" src="http://www.imperdiblesoft.com/img/tipos_cuenta/'.$tipo_cuenta[$_SESSION['tipo_cuenta']]['nombre'].'.png"  class="explicacion" alt="Tipo de cuenta '.$tipo_cuenta[$_SESSION['tipo_cuenta']]['nombre'].'" /> '.$_SESSION['nombre'].'</li>';
